...
public class RecruiterArrivalProcess extends SimEntityBase {
    ...
    */
   public void doRun() {
      waitDelay("RecruiterArrival", (int)arrivalTimeGenerator.generate(), 5.0);
   } // end doRun
    ...
    * @param seed The random number seed
    */
   public RecruiterArrivalProcess(String distribution, Object[] parameters, long seed) {
      arrivalTimeGenerator = RandomVariateFactory.getInstance(
                             distribution, parameters, seed);
   } // end RecruiterArrivalProcess constructor
