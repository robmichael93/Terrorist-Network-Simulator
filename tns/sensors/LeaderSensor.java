...
/**
 * This sensor senses Leaders. <B>Not currently in use.</B>
 * @author  Rob Michael and Zac Staples
 */
public class LeaderSensor implements TNSSensor {
    ...
    /** 
     * Creates a new instance of LeaderSensor 
     * @param r The range of the sensor in logical space.
     */
    public LeaderSensor(double r) {
        range = r;
    } // end LeaderSensor constructor
...
//                    System.out.println(entityName + " detected " + t.getAgentName());
                    sensedAgents.add(t);
                } // end if
            } // end while
        } // end for
