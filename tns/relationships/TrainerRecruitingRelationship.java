...
/**
 * Leaders and trainers join into a similar relationship as that between leaders
 * and recruiters to fill the other half of the critical role of keeping the 
 ...
 */
public class TrainerRecruitingRelationship implements TNSRelationship {
...
//            System.out.println(pAgent.getAgentName() + " added to " + this.toString());
            ...
            // is a leader or trainer, then add the trainer as a listener
            // to the leader's FindTrainerConnector.
            ...
            while (e.hasMoreElements()) {
                ...
                // Check Role type: Leader or Trainer?
...
//        System.out.println(this.toString() + " being destroyed.");
    ...
    public boolean removeAgent(Agent pAgent) {
        ...
        // is a leader or trainer, then remove the trainer as a listener
        // to the leader's FindTrainerConnector.
...
} // end class TrainerRecruitingRelationship
