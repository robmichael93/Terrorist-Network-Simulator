...
/**
 * Leaders and arms dealers share the arms bartering relationship so that the 
 * leader can gather the necessary instruments of terror for the mission at hand.
 * @author  Rob Michael and Zac Staples
 */
public class ArmsBarteringRelationship implements TNSRelationship {
    ...
    /** Creates a new instance of ArmsBarteringRelationship */
    public ArmsBarteringRelationship() {
        name = new String("ArmsBarteringRelationship");
        members = new Vector();
        associatedRoles = new Vector();
        associatedRoles.add(new String("LeaderRole"));
        associatedRoles.add(new String("ArmsDealerRole"));
//        System.out.println(name + " created.");
    } // end ArmsBarteringRelationship constructor
...
//        System.out.println(pAgent.getAgentName() + " added to " + this.toString());
        ...
        // is a leader or arms dealer, then add the arms dealer as a listener
        // to the leader's RequestArmsConnector.
            ...
            if (r instanceof LeaderRole) { // if Leader
                ...
                while (e2.hasMoreElements()) {
                    ...
                    while (e3.hasMoreElements()) {
                        ...
                        if (agentRole instanceof ArmsDealerRole) {
                            armsDealers.add(agentRole);
                        } // end if-else
                    } // end while
                } // end while
                ...
                while (e7.hasMoreElements()) {
                    ...
                    if (c instanceof RequestArmsConnector) {
                        for (int i = 0; i < armsDealers.size(); i++) {
                            ArmsDealerRole armsDealer = (ArmsDealerRole)armsDealers.elementAt(i);
/*                            System.out.println("Attempting to add " + armsDealer.getAgent().getAgentName() +
                                " as a listener to " + ((TNSRole)r).getAgent().getAgentName() +
                                "'s RequestArmsConnector");*/
                            c.addConnectorChangeListener(armsDealer);
                        } // end for
                    } // end if-else
                } // end while
                
            } else if (r instanceof ArmsDealerRole) { // if ArmsDealer
...
/*                            System.out.println("Attempting to add " + ((TNSRole)r).getAgent().getAgentName() +
                                ...
                                "'s RequestArmsConnector");*/
                            c.addConnectorChangeListener((ArmsDealerRole)r);
                        } // end if-else
                    } // end while
                } // end for
            } // end if-else
...
//        System.out.println(this.toString() + " being destroyed.");
    ...
    public boolean removeAgent(Agent pAgent) {
        ...
        // is a leader or arms dealer, then remove the arms dealer as a listener
        // to the leader's RequestArmsConnector.
            ...
            if (r instanceof LeaderRole) { // if Leader
                ...
                while (e7.hasMoreElements()) {
                    ...
                    if (c instanceof RequestArmsConnector) {
                        for (int i = 0; i < armsDealers.size(); i++) {
                            ArmsDealerRole armsDealer = (ArmsDealerRole)armsDealers.elementAt(i);
/*                            System.out.println("Attempting to remove " + armsDealer.getAgent().getAgentName() +
                                " as a listener from " + ((TNSRole)r).getAgent().getAgentName() +
                                "'s RequestArmsConnector");*/
                            c.removeConnectorChangeListener(armsDealer);
                        } // end for
                    } // end if-else
                } // end while
...
/*                            System.out.println("Attempting to remove " + ((TNSRole)r).getAgent().getAgentName() +
                                ...
                                "'s RequestArmsConnector");*/
                            c.removeConnectorChangeListener((ArmsDealerRole)r);
                        } // end if-else
                    } // end while
                } // end for
            } // end if-else
...
} // end class ArmsBarteringRelationship
