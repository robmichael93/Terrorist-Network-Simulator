...
//        System.out.println(pAgent.getAgentName() + " added to " + this.toString());
        ...
        // is a leader or financier, then add the financier as a listener
        // to the leader's RequestFinancesConnector.
...
//        System.out.println(this.toString() + " being destroyed.");
    ...
    public boolean removeAgent(Agent pAgent) {
        ...
        // is a leader or financier, then remove the financier as a listener
        // to the leader's RequestFinancesConnector.
