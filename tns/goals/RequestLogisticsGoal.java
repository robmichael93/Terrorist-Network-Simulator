 ...
 */
public class RequestLogisticsGoal implements TNSGoal {
    ...
    /** 
     * Creates a new instance of RequestLogisticsGoal 
     * @param role The role that owns this goal.
     */
    public RequestLogisticsGoal(Role role) {
        this.role = role;
        goalName = new String("RequestLogisticsGoal");
//        System.out.println(goalName + " created.");
    ...
    public void assignCredit(SensedEnvironment pPE) {
        ...
        if (missionPlanned && !((LeaderRole)role).getMission().hasNeededLogistics()) {
            ...
            if (target != null) {
                ...
                int neededLogistics = requiredLogistics - mission.getLogisticsCount();
...
//        System.out.println(goalName + " completed.");
    ...
    public void executeActiveTicket() {
        Ticket requestLogistics = new RequestLogisticsTicket(role);
        requestLogistics.execute();
    }
