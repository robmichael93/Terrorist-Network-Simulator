...
/**
 * This goal gives the leader the behavior of finding a training area for his
 * cell to rehearse their mission by knowing about a trainer that has a training
 * area.
 * @author  Rob Michael and Zac Staples
 */
public class RequestTrainingGoal implements TNSGoal {
    ...
    /** 
     * Creates a new instance of RequestTrainingGoal 
     * @param role The role that owns this goal.
     */
    public RequestTrainingGoal(Role role) {
        this.role = role;
        goalName = new String("RequestTrainingGoal");
    ...
    public void assignCredit(SensedEnvironment sensedEnvironment) {
        ...
        if (missionPlanned) {
            ...
            if (!trainerFound) {
                ...
                weight = 0;
                completed = true;
                ((LeaderRole)role).getMission().setTrainingAreaComplete();
            } // end if-else
        } else {
            weight = 0;
        } // end if-else
...
//        System.out.println(goalName + " completed.");
    ...
    public void executeActiveTicket() {
        ...
        while (e.hasMoreElements()) {
            ...
            if (t instanceof RequestTrainingTicket) {
                t.execute();
            }  // end if
        } // end while
    }
