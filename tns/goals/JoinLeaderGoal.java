...
/**
 * The first priority of an operator is to get into a cell.  This goal creates 
 * the behavior of an operator looking for that opportunity.  The operator can 
 * either go through the trainer or ask around the organization to accomplish 
 * this goal.
 * @author  Rob Michael and Zac Staples
 */
public class JoinLeaderGoal implements TNSGoal {
     ...
     */
    public JoinLeaderGoal(Role role) {
        this.role = role;
        goalName = new String("JoinLeaderGoal");
...
//        System.out.println(goalName + " weight: " + weight);
    ...
    public void executeActiveTicket() {
        Ticket joinLeader = new JoinLeaderTicket(role);
        joinLeader.execute();
    }
