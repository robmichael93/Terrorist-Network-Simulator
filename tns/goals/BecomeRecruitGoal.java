 ...
 */
public class BecomeRecruitGoal implements TNSGoal {
    ...
    /** 
     * Creates a new instance of BecomeRecruitGoal 
     * @param role The role that owns this goal.
     */
    public BecomeRecruitGoal(Role role) {
        this.role = role;
        goalName = new String("BecomeRecruitGoal");
//        System.out.println(goalName + " created.");
    ...
    public void assignCredit(SensedEnvironment pPE) {
        // The Contact wants to find out if the MakeContact goal was
        // completed.  If it has, then weight the BecomeRecruit goal high,
        // otherwise, give it no weight until the MakeContact goal becomes
        // completed
        Goal makeContact = null;
        ...
        if (((TNSGoal)makeContact).isCompleted()) {
            weight = 10;
        } else {
            weight = 0;
        } // end if-else
...
//        System.out.println(goalName + " completed.");
    ...
    public void executeActiveTicket() {
        ...
        while (e.hasMoreElements()) {
            ...
            if (t instanceof BecomeRecruitTicket) {
                t.execute();
            } // end if
        } // end while
    }
