...
/**
 * If the agent becomes bored or disavowed because he has not participated in a 
 * mission for a given length of time, this goal gives him the behavior to 
 * possibly advance to the trainer role.
 * @author  Rob Michael and Zac Staples
 */
public class OperatorAdvanceGoal implements TNSGoal {
     ...
     */
    public OperatorAdvanceGoal(Role role) {
        this.role = role;
        goalName = new String("OperatorAdvanceGoal");
//        System.out.println(goalName + " created.");
    ...
    public void assignCredit(SensedEnvironment pPE) {
        int stuckCounter = ((OperatorRole)role).getStuckCounter();
        int stuckThreshold = ((OperatorRole)role).getStuckThreshold();
...
//        System.out.println(goalName + " completed.");
    ...
    public void executeActiveTicket() {
        Ticket operatorAdvance = new OperatorAdvanceTicket(role, "TrainerRole");
