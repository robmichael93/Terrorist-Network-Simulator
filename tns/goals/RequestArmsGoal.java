 ...
 */
public class RequestArmsGoal implements TNSGoal {
    ...
    /** 
     * Creates a new instance of RequestArmsGoal 
     * @param role The role that owns this goal.
     */
    public RequestArmsGoal(Role role) {
        this.role = role;
        goalName = new String("RequestArmsGoal");
...
//        System.out.println(goalName + " completed.");
    ...
    public void executeActiveTicket() {
        Ticket requestArms = new RequestArmsTicket(role);
        requestArms.execute();
    }
