...
/**
 * Class for handling XML BranchingFrame tags.  This class is a <b>Singleton</b>
 ...
 */
public class BranchingFrame extends DocumentParseState {

  /**
   * The single BranchingFrame
   */
  private static BranchingFrame theirInstance = null;

  /**
   * The constructor is <code>private</code> to enforce <b>Singleton</b>
   * behavior
   */
  private BranchingFrame() {
  }

  /**
   * Return the BranchingFrame <b>Singleton</b>
   * @return The BranchingFrame <b>Singleton</b>
   */
  public static BranchingFrame Instance() {
    if( theirInstance == null ) {
      theirInstance = new BranchingFrame();
    }
    return theirInstance;
  }

  /**
   * This state is called when a <b>&lt;BranchingFrame&gt;</b> element is parsed.
  ...
  public void InitializeState( ParserStateMachine context ) {
    ...
    context.AddConstructionTask( new ConstructionMethodCall( "AddBranchingFrame", new Class[] { int.class, String.class, String.class, int.class, int.class } ) );
  }

  /**
   * This state is called when we start a sub-element of state BranchingFrame
   * @param context The <code>ParserStateMachine</code> that is managing our parsing
   * @param uri
   * @param localName
   * @param qName
  ...
  /**
   * This state is called when we get the end element for state BranchingFrame
   * @param context The <code>ParserStateMachine</code> that is managing our parsing
   * @param uri
   * @param localName
   * @param qName
  ...
  /**
   * This state is called when SAX generates a <code>characters</code> event while in state BranchingFrame
   * @param context The <code>ParserStateMachine</code> that is managing our parsing
   * @param ch
   * @param start
   * @param length
