...
/**
 * Class for handling XML Uniform tags.  This class is a <b>Singleton</b>
 ...
 */
public class Uniform extends DocumentParseState {

  /**
   * The single Uniform
   */
  private static Uniform theirInstance = null;
  ...
  /**
   * Return the Uniform <b>Singleton</b>
   * @return The Uniform <b>Singleton</b>
   */
  public static Uniform Instance() {
    if( theirInstance == null ) {
      theirInstance = new Uniform();
    }
    return theirInstance;
  }

  /**
   * This state is called when a <b>&lt;Uniform&gt;</b> element is parsed.
  ...
  /**
   * This state is called when we start a sub-element of state Uniform
   * @param context The <code>ParserStateMachine</code> that is managing our parsing
   * @param uri
   * @param localName
   * @param qName
  ...
  /**
   * This state is called when we get the end element for state Uniform
   * @param context The <code>ParserStateMachine</code> that is managing our parsing
   * @param uri
   * @param localName
   * @param qName
  ...
  /**
   * This state is called when SAX generates a <code>characters</code> event while in state Uniform
   * @param context The <code>ParserStateMachine</code> that is managing our parsing
   * @param ch
   * @param start
   * @param length
