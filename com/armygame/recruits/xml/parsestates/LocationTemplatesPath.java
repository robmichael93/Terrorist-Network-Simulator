...
/**
 * Class for handling XML LocationTemplatesPath tags.  This class is a <b>Singleton</b>
 ...
 */
public class LocationTemplatesPath extends DocumentParseState {

  /**
   * The single LocationTemplatesPath
   */
  private static LocationTemplatesPath theirInstance = null;

  /**
   * The constructor is <code>private</code> to enforce <b>Singleton</b>
   * behavior
   */
  private LocationTemplatesPath() {
  }

  /**
   * Return the LocationTemplatesPath <b>Singleton</b>
   * @return The LocationTemplatesPath <b>Singleton</b>
   */
  public static LocationTemplatesPath Instance() {
    if( theirInstance == null ) {
      theirInstance = new LocationTemplatesPath();
    }
  ...
  /**
   * This state is called when we get the end element for state LocationTemplatesPath
  ...
  public void EndElement( ParserStateMachine context, String uri, String localName, String qName ) {
    context.AddConstructionTask( new ConstructionMethodCall( "SetLocationTemplatesRelativePath", new Class[] { String.class } ) );
