...
/**
 * Class for handling XML ProbabilityOfOccurrence tags.  This class is a <b>Singleton</b>
 ...
 */
public class ProbabilityOfOccurrence extends DocumentParseState {

  /**
   * The single ProbabilityOfOccurrence
   */
  private static ProbabilityOfOccurrence theirInstance = null;
  ...
  /**
   * Return the ProbabilityOfOccurrence <b>Singleton</b>
   * @return The ProbabilityOfOccurrence <b>Singleton</b>
   */
  public static ProbabilityOfOccurrence Instance() {
    if( theirInstance == null ) {
      theirInstance = new ProbabilityOfOccurrence();
    }
  ...
  /**
   * This state is called when we get the end element for state ProbabilityOfOccurrence
  ...
  public void EndElement( ParserStateMachine context, String uri, String localName, String qName ) {
    context.AddConstructionTask( new ConstructionMethodCall( "SetProbabilityOfOccurrence", new Class[] { int.class } ) );
