...
/**
 * Class for handling XML Hat tags.  This class is a <b>Singleton</b>
 ...
 */
public class Hat extends DocumentParseState {

  /**
   * The single Hat
   */
  private static Hat theirInstance = null;
  ...
  /**
   * Return the Hat <b>Singleton</b>
   * @return The Hat <b>Singleton</b>
   */
  public static Hat Instance() {
    if( theirInstance == null ) {
      theirInstance = new Hat();
    }
    return theirInstance;
  }

  /**
   * This state is called when a <b>&lt;Hat&gt;</b> element is parsed.
  ...
  /**
   * This state is called when we start a sub-element of state Hat
   * @param context The <code>ParserStateMachine</code> that is managing our parsing
   * @param uri
   * @param localName
   * @param qName
  ...
  /**
   * This state is called when we get the end element for state Hat
   * @param context The <code>ParserStateMachine</code> that is managing our parsing
   * @param uri
   * @param localName
   * @param qName
  ...
  public void EndElement( ParserStateMachine context, String uri, String localName, String qName ) {
    ...
    context.AddConstructionTask( new ConstructionMethodCall( "SetHat", new Class[] { String.class } ) );
  ...
  /**
   * This state is called when SAX generates a <code>characters</code> event while in state Hat
   * @param context The <code>ParserStateMachine</code> that is managing our parsing
   * @param ch
   * @param start
   * @param length
