...
/**
 * Title: LocationTemplateElementsList
...
/**
 * Class for handling XML LocationTemplateElementsList tags.  This class is a <b>Singleton</b>
 ...
 */
public class LocationTemplateElementsList extends com.armygame.recruits.xml.DocumentParseState {

  /**
   * The single LocationTemplateElementsList
   */
  private static LocationTemplateElementsList theirInstance = null;

  /**
   * The constructor is <code>private</code> to enforce <b>Singleton</b>
   * behavior
   */
  private LocationTemplateElementsList() {
    super();
  }

  /**
   * Return the LocationTemplateElementsList <b>Singleton</b>
   * @return The LocationTemplateElementsList <b>Singleton</b>
   */
  public static LocationTemplateElementsList Instance() {
    if( theirInstance == null ) {
      theirInstance = new LocationTemplateElementsList();
    }
