...
/**
 * Title: LocationMediaElementsFile
...
/**
 * Class for handling XML LocationMediaElementsFile tags.  This class is a <b>Singleton</b>
 ...
 */
public class LocationMediaElementsFile extends DocumentParseState implements RecruitsPackageConstants {

  /**
   * The single LocationMediaElementsFile
   */
  private static LocationMediaElementsFile theirInstance = null;

  /**
   * The constructor is <code>private</code> to enforce <b>Singleton</b>
   * behavior
   */
  private LocationMediaElementsFile() {
    super();
  }

  /**
   * Return the LocationMediaElementsFile <b>Singleton</b>
   * @return The LocationMediaElementsFile <b>Singleton</b>
   */
  public static LocationMediaElementsFile Instance() {
    if( theirInstance == null ) {
      theirInstance = new LocationMediaElementsFile();
    }
    return theirInstance;
  }

  /**
   * This state is called when we get the end element for state LocationMediaElementsFile
