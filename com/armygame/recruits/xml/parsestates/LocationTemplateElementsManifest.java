...
/**
 * Title: LocationTemplateElementsManifest
...
/**
 * Class for handling XML LocationTemplateElementsManifest tags.  This class is a <b>Singleton</b>
 ...
 */
public class LocationTemplateElementsManifest extends DocumentParseState implements RecruitsPackageConstants {

  /**
   * The single LocationTemplateElementsManifest
   */
  private static LocationTemplateElementsManifest theirInstance = null;

  /**
   * The constructor is <code>private</code> to enforce <b>Singleton</b>
   * behavior
   */
  private LocationTemplateElementsManifest() {
  }

  /**
   * Return the LocationTemplateElementsManifest <b>Singleton</b>
   * @return The LocationTemplateElementsManifest <b>Singleton</b>
   */
  public static LocationTemplateElementsManifest Instance() {
    if( theirInstance == null ) {
      theirInstance = new LocationTemplateElementsManifest();
    }
    return theirInstance;
  }

  /**
   * This state is called when we get the end element for state LocationTemplateElementsManifest
