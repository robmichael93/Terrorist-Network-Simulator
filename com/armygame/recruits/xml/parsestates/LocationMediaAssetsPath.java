...
/**
 * Class for handling XML LocationMediaAssetsPath tags.  This class is a <b>Singleton</b>
 ...
 */
public class LocationMediaAssetsPath extends DocumentParseState {

  /**
   * The single LocationMediaAssetsPath
   */
  private static LocationMediaAssetsPath theirInstance = null;

  /**
   * The constructor is <code>private</code> to enforce <b>Singleton</b>
   * behavior
   */
  private LocationMediaAssetsPath() {
  }

  /**
   * Return the LocationMediaAssetsPath <b>Singleton</b>
   * @return The LocationMediaAssetsPath <b>Singleton</b>
   */
  public static LocationMediaAssetsPath Instance() {
    if( theirInstance == null ) {
      theirInstance = new LocationMediaAssetsPath();
    }
  ...
  /**
   * This state is called when we get the end element for state LocationMediaAssetsPath
  ...
  public void EndElement( ParserStateMachine context, String uri, String localName, String qName ) {
    context.AddConstructionTask( new ConstructionMethodCall( "SetLocationMediaAssetsRelativePath", new Class[] { String.class } ) );
