...
/**
 * Class for handling XML LocationTemplatePath tags.  This class is a <b>Singleton</b>
 ...
 */
public class LocationTemplatePath extends DocumentParseState {

  /**
   * The single LocationTemplatePath
   */
  private static LocationTemplatePath theirInstance = null;

  /**
   * The constructor is <code>private</code> to enforce <b>Singleton</b>
   * behavior
   */
  private LocationTemplatePath() {
  }

  /**
   * Return the LocationTemplatePath <b>Singleton</b>
   * @return The LocationTemplatePath <b>Singleton</b>
   */
  public static LocationTemplatePath Instance() {
    if( theirInstance == null ) {
      theirInstance = new LocationTemplatePath();
    }
  ...
  /**
   * This state is called when we get the end element for state LocationTemplatePath
