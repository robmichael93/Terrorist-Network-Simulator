...
/**
 * Class for handling XML ShadowImageName tags.  This class is a <b>Singleton</b>
 ...
 */
public class ShadowImageName extends DocumentParseState {

  /**
   * The single ShadowImageName
   */
  private static ShadowImageName theirInstance = null;

  /**
   * The constructor is <code>private</code> to enforce <b>Singleton</b>
   * behavior
   */
  private ShadowImageName() {
    super();
  }

  /**
   * Return the ShadowImageName <b>Singleton</b>
   * @return The ShadowImageName <b>Singleton</b>
   */
  public static ShadowImageName Instance() {
    if( theirInstance == null ) {
      theirInstance = new ShadowImageName();
    }
  ...
  /**
   * This state is called when we get the end element for state ShadowImageName
  ...
  public void EndElement( ParserStateMachine context, String uri, String localName, String qName ) {
    context.AddConstructionTask( new ConstructionMethodCall( "SetImageName", new Class[] { String.class } ) );
