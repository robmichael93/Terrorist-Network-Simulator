...
/**
 * Class for handling XML Frames tags.  This class is a <b>Singleton</b>
 ...
 */
public class Frames extends DocumentParseState {

  /**
   * The single Frames
   */
  private static Frames theirInstance = null;
  ...
  /**
   * Return the Frames <b>Singleton</b>
   * @return The Frames <b>Singleton</b>
   */
  public static Frames Instance() {
    if( theirInstance == null ) {
      theirInstance = new Frames();
    }
