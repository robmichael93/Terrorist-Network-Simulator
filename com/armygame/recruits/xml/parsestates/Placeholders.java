...
/**
 * Class for handling XML Placeholders tags.  This class is a <b>Singleton</b>
 ...
 */
public class Placeholders extends DocumentParseState {

  /**
   * The single Placeholders
   */
  private static Placeholders theirInstance = null;
  ...
  /**
   * Return the Placeholders <b>Singleton</b>
   * @return The Placeholders <b>Singleton</b>
   */
  public static Placeholders Instance() {
    if( theirInstance == null ) {
      theirInstance = new Placeholders();
    }
