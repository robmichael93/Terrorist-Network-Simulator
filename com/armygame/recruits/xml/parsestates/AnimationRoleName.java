...
/**
 * Class for handling XML AnimationRoleName tags.  This class is a <b>Singleton</b>
 ...
 */
public class AnimationRoleName extends DocumentParseState {

  /**
   * The single AnimationRoleName
   */
  private static AnimationRoleName theirInstance = null;

  /**
   * The constructor is <code>private</code> to enforce <b>Singleton</b>
   * behavior
   */
  private AnimationRoleName() {
    super();
  }

  /**
   * Return the AnimationRoleName <b>Singleton</b>
   * @return The AnimationRoleName <b>Singleton</b>
   */
  public static AnimationRoleName Instance() {
    if( theirInstance == null ) {
      theirInstance = new AnimationRoleName();
    }
  ...
  /**
   * This state is called when we get the end element for state AnimationRoleName
  ...
  public void EndElement( ParserStateMachine context, String uri, String localName, String qName ) {
    context.AddConstructionTask( new ConstructionMethodCall( "SetRoleName", new Class[] { String.class } ) );
