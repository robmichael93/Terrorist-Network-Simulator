...
/**
 * Class for handling XML AnimationImagesPath tags.  This class is a <b>Singleton</b>
 ...
 */
public class AnimationImagesPath extends DocumentParseState {

  /**
   * The single AnimationImagesPath
   */
  private static AnimationImagesPath theirInstance = null;

  /**
   * The constructor is <code>private</code> to enforce <b>Singleton</b>
   * behavior
   */
  private AnimationImagesPath() {
  }

  /**
   * Return the AnimationImagesPath <b>Singleton</b>
   * @return The AnimationImagesPath <b>Singleton</b>
   */
  public static AnimationImagesPath Instance() {
    if( theirInstance == null ) {
      theirInstance = new AnimationImagesPath();
    }
  ...
  /**
   * This state is called when we get the end element for state AnimationImagesPath
  ...
  public void EndElement( ParserStateMachine context, String uri, String localName, String qName ) {
    context.AddConstructionTask( new ConstructionMethodCall( "SetAnimationImagesRootPath", new Class[] { String.class } ) );
