...
/**
 * Title: LocationMediaElementsList
...
/**
 * Class for handling XML LocationMediaElementsList tags.  This class is a <b>Singleton</b>
 ...
 */
public class LocationMediaElementsList extends com.armygame.recruits.xml.DocumentParseState {

  /**
   * The single LocationMediaElementsList
   */
  private static LocationMediaElementsList theirInstance = null;

  /**
   * The constructor is <code>private</code> to enforce <b>Singleton</b>
   * behavior
   */
  private LocationMediaElementsList() {
    super();
  }

  /**
   * Return the LocationMediaElementsList <b>Singleton</b>
   * @return The LocationMediaElementsList <b>Singleton</b>
   */
  public static LocationMediaElementsList Instance() {
    if( theirInstance == null ) {
      theirInstance = new LocationMediaElementsList();
    }
