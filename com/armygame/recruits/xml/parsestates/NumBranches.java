...
/**
 * Class for handling XML NumBranches tags.  This class is a <b>Singleton</b>
 ...
 */
public class NumBranches extends DocumentParseState {

  /**
   * The single NumBranches
   */
  private static NumBranches theirInstance = null;
  ...
  /**
   * Return the NumBranches <b>Singleton</b>
   * @return The NumBranches <b>Singleton</b>
   */
  public static NumBranches Instance() {
    if( theirInstance == null ) {
      theirInstance = new NumBranches();
    }
    return theirInstance;
  }

  /**
   * This state is called when a <b>&lt;NumBranches&gt;</b> element is parsed.
  ...
  /**
   * This state is called when we start a sub-element of state NumBranches
   * @param context The <code>ParserStateMachine</code> that is managing our parsing
   * @param uri
   * @param localName
   * @param qName
  ...
  /**
   * This state is called when we get the end element for state NumBranches
   * @param context The <code>ParserStateMachine</code> that is managing our parsing
   * @param uri
   * @param localName
   * @param qName
  ...
  /**
   * This state is called when SAX generates a <code>characters</code> event while in state NumBranches
   * @param context The <code>ParserStateMachine</code> that is managing our parsing
   * @param ch
   * @param start
   * @param length
