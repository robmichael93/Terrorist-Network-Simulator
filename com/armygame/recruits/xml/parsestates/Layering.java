...
/**
 * Class for handling XML Layering tags.  This class is a <b>Singleton</b>
 ...
 */
public class Layering extends DocumentParseState {

  /**
   * The single Layering
   */
  private static Layering theirInstance = null;
  ...
  /**
   * Return the Layering <b>Singleton</b>
   * @return The Layering <b>Singleton</b>
   */
  public static Layering Instance() {
    if( theirInstance == null ) {
      theirInstance = new Layering();
    }
  ...
  /**
   * This state is called when we get the end element for state Layering
  ...
  public void EndElement( ParserStateMachine context, String uri, String localName, String qName ) {
    context.AddConstructionTask( new ConstructionMethodCall( "SetLayering", new Class[] { String.class } ) );
