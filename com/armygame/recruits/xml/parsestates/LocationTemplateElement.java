...
/**
 * Class for handling XML LocationTemplateElement tags.  This class is a <b>Singleton</b>
 ...
 */
public class LocationTemplateElement extends DocumentParseState implements RecruitsPackageConstants {

  /**
   * The single LocationTemplateElement
   */
  private static LocationTemplateElement theirInstance = null;

  /**
   * The constructor is <code>private</code> to enforce <b>Singleton</b>
   * behavior
   */
  private LocationTemplateElement() {
    super();
  }

  /**
   * Return the LocationTemplateElement <b>Singleton</b>
   * @return The LocationTemplateElement <b>Singleton</b>
   */
  public static LocationTemplateElement Instance() {
    if( theirInstance == null ) {
      theirInstance = new LocationTemplateElement();
    }
    return theirInstance;
  }

  /**
   * This state is called when a <b>&lt;LocationTemplateElement&gt;</b> element is parsed.
  ...
  public void InitializeState( ParserStateMachine context ) {
    context.AddConstructionTask( new ConstructionMethodCall( "TrieInsert", new Class[] { TargetObjectKey.class } ) );

  }

  /**
   * This state is called when we get the end element for state LocationTemplateElement
   * @param context The <code>ParserStateMachine</code> that is managing our parsing
   * @param uri
   * @param localName
   * @param qName
