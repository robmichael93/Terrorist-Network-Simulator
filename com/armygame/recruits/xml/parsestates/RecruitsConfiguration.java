...
/**
 * Class for handling XML RecruitsConfiguration tags.  This class is a <b>Singleton</b>
 ...
 */
public class RecruitsConfiguration extends DocumentParseState implements RecruitsPackageConstants {

  /**
   * The single RecruitsConfiguration
   */
  private static RecruitsConfiguration theirInstance = null;

  /**
   * The constructor is <code>private</code> to enforce <b>Singleton</b>
   * behavior
   */
  private RecruitsConfiguration() {
  }
  ...
  public static RecruitsConfiguration Instance() {
    if( theirInstance == null ) {
      theirInstance = new RecruitsConfiguration();
    }
    return theirInstance;
  }

  /**
   * This state is called when we get the end element for state RecruitsConfiguration
