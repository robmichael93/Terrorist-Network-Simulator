...
/**
 * Class for handling XML CharacterShadow tags.  This class is a <b>Singleton</b>
 ...
 */
public class CharacterShadow extends DocumentParseState implements RecruitsPackageConstants {

  /**
   * The single CharacterShadow
   */
  private static CharacterShadow theirInstance = null;

  /**
   * The constructor is <code>private</code> to enforce <b>Singleton</b>
   * behavior
   */
  private CharacterShadow() {
    super();
  }

  /**
   * Return the CharacterShadow <b>Singleton</b>
   * @return The CharacterShadow <b>Singleton</b>
   */
  public static CharacterShadow Instance() {
    if( theirInstance == null ) {
      theirInstance = new CharacterShadow();
    }
    return theirInstance;
  }

  /**
   * This state is called when a <b>&lt;CharacterShadow&gt;</b> element is parsed.
  ...
  public void InitializeState( ParserStateMachine context ) {
    ...
    context.AddConstructionTask( new ConstructionMethodCall( "SetShadow", new Class[] { PlaceholderShadow.class } ) );
    context.AddConstructionTask( new ConstructorCall( LOCATIONS_PACKAGE, "PlaceholderShadow" ) );
  }


  /**
   * This state is called when we get the end element for state CharacterShadow
   * @param context The <code>ParserStateMachine</code> that is managing our parsing
   * @param uri
   * @param localName
   * @param qName
