...
/**
 * Class for handling XML NumberOfFrames tags.  This class is a <b>Singleton</b>
 ...
 */
public class NumberOfFrames extends DocumentParseState {

  /**
   * The single NumberOfFrames
   */
  private static NumberOfFrames theirInstance = null;
  ...
  /**
   * Return the NumberOfFrames <b>Singleton</b>
   * @return The NumberOfFrames <b>Singleton</b>
   */
  public static NumberOfFrames Instance() {
    if( theirInstance == null ) {
      theirInstance = new NumberOfFrames();
    }
    return theirInstance;
  }

  /**
   * This state is called when a <b>&lt;NumberOfFrames&gt;</b> element is parsed.
  ...
  /**
   * This state is called when we start a sub-element of state NumberOfFrames
   * @param context The <code>ParserStateMachine</code> that is managing our parsing
   * @param uri
   * @param localName
   * @param qName
  ...
  /**
   * This state is called when we get the end element for state NumberOfFrames
   * @param context The <code>ParserStateMachine</code> that is managing our parsing
   * @param uri
   * @param localName
   * @param qName
  ...
  public void EndElement( ParserStateMachine context, String uri, String localName, String qName ) {
    ...
    context.AddConstructionTask( new ConstructionMethodCall( "SetFrameCount", new Class[] { int.class } ) );
    context.AddConstructionTask( new IntArgument( context.CharBufferToInt() ) );
    context.AddConstructionTask( new EndMethodCallSentinel() );
  }

  /**
   * This state is called when SAX generates a <code>characters</code> event while in state NumberOfFrames
   * @param context The <code>ParserStateMachine</code> that is managing our parsing
   * @param ch
   * @param start
   * @param length
