...
/**
 * Class for handling XML AnimationName tags.  This class is a <b>Singleton</b>
 ...
 */
public class AnimationName extends DocumentParseState {

  /**
   * The single AnimationName
   */
  private static AnimationName theirInstance = null;
  ...
  /**
   * Return the AnimationName <b>Singleton</b>
   * @return The AnimationName <b>Singleton</b>
   */
  public static AnimationName Instance() {
    if( theirInstance == null ) {
      theirInstance = new AnimationName();
    }
