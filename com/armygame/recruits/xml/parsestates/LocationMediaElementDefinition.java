...
/**
 * Title: LocationMediaElementDefinition
...
/**
 * Class for handling XML LocationMediaElementDefinition tags.  This class is a <b>Singleton</b>
 ...
 */
public class LocationMediaElementDefinition extends DocumentParseState {

  /**
   * The single LocationMediaElementDefinition
   */
  private static LocationMediaElementDefinition theirInstance = null;

  /**
   * The constructor is <code>private</code> to enforce <b>Singleton</b>
   * behavior
   */
  private LocationMediaElementDefinition() {
    super();
  }

  /**
   * Return the LocationMediaElementDefinition <b>Singleton</b>
   * @return The LocationMediaElementDefinition <b>Singleton</b>
   */
  public static LocationMediaElementDefinition Instance() {
    if( theirInstance == null ) {
      theirInstance = new LocationMediaElementDefinition();
    }
  ...
  /**
   * This state is called when we get the end element for state LocationMediaElementDefinition
