...
/**
 * Class for handling XML RangeName tags.  This class is a <b>Singleton</b>
 ...
 */
public class OverrideRangeName extends DocumentParseState {

  /**
   * The single RangeName
   */
  private static OverrideRangeName theirInstance = null;

  /**
   * The constructor is <code>private</code> to enforce <b>Singleton</b>
   * behavior
   */
  private OverrideRangeName() {
    super();
  }

  /**
   * Return the RangeName <b>Singleton</b>
   * @return The RangeName <b>Singleton</b>
   */
  public static OverrideRangeName Instance() {
    if( theirInstance == null ) {
      theirInstance = new OverrideRangeName();
    }
  ...
  /**
   * This state is called when we get the end element for state RangeName
  ...
  public void EndElement( ParserStateMachine context, String uri, String localName, String qName ) {
    context.RememberTagValue( com.armygame.recruits.xml.ReflectiveStateDispatcher.NormalizeName( qName ) );
  }
