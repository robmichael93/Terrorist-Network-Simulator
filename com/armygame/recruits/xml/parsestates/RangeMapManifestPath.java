...
/**
 * Class for handling XML RangeMapManifestPath tags.  This class is a <b>Singleton</b>
 ...
 */
public class RangeMapManifestPath extends DocumentParseState {

  /**
   * The single RangeMapManifestPath
   */
  private static RangeMapManifestPath theirInstance = null;

  /**
   * The constructor is <code>private</code> to enforce <b>Singleton</b>
   * behavior
   */
  private RangeMapManifestPath() {
  }

  /**
   * Return the RangeMapManifestPath <b>Singleton</b>
   * @return The RangeMapManifestPath <b>Singleton</b>
   */
  public static RangeMapManifestPath Instance() {
    if( theirInstance == null ) {
      theirInstance = new RangeMapManifestPath();
    }
  ...
  /**
   * This state is called when we get the end element for state RangeMapManifestPath
  ...
  public void EndElement( ParserStateMachine context, String uri, String localName, String qName ) {
    context.AddConstructionTask( new ConstructionMethodCall( "SetRangeMapRelativePath", new Class[] { String.class } ) );
