...
/**
 * Class for handling XML DescriptiveName tags.  This class is a <b>Singleton</b>
 ...
 */
public class DescriptiveName extends DocumentParseState {

  /**
   * The single DescriptiveName
   */
  private static DescriptiveName theirInstance = null;
  ...
  /**
   * Return the DescriptiveName <b>Singleton</b>
   * @return The DescriptiveName <b>Singleton</b>
   */
  public static DescriptiveName Instance() {
    if( theirInstance == null ) {
      theirInstance = new DescriptiveName();
    }
    return theirInstance;
  }

  /**
   * This state is called when we get the end element for state DescriptiveName
  ...
  public void EndElement( ParserStateMachine context, String uri, String localName, String qName ) {
    context.RememberTagValue( "DescriptiveName" );
  }
