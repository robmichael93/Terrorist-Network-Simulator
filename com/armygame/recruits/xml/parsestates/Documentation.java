...
/**
 * Class for handling XML Documentation tags.  This class is a <b>Singleton</b>
 ...
 */
public class Documentation extends com.armygame.recruits.xml.DocumentParseState {

  /**
   * The single Documentation
   */
  private static Documentation theirInstance = null;
  ...
  /**
   * Return the Documentation <b>Singleton</b>
   * @return The Documentation <b>Singleton</b>
   */
  public static Documentation Instance() {
    if( theirInstance == null ) {
      theirInstance = new Documentation();
    }
