...
/**
 * Class for handling XML AnimationHat tags.  This class is a <b>Singleton</b>
 ...
 */
public class AnimationHat extends DocumentParseState {

  /**
   * The single AnimationHat
   */
  private static AnimationHat theirInstance = null;

  /**
   * The constructor is <code>private</code> to enforce <b>Singleton</b>
   * behavior
   */
  private AnimationHat() {
    super();
  }

  /**
   * Return the AnimationHat <b>Singleton</b>
   * @return The AnimationHat <b>Singleton</b>
   */
  public static AnimationHat Instance() {
    if( theirInstance == null ) {
      theirInstance = new AnimationHat();
    }
  ...
  /**
   * This state is called when we get the end element for state AnimationHat
