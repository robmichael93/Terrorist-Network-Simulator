...
/**
 * Title: LocationTemplateKeyStateVector
...
/**
 * Class for handling XML LocationTemplateKeyStateVector tags.  This class is a <b>Singleton</b>
 ...
 */
public class LocationTemplateKeyStateVector extends DocumentParseState implements RecruitsPackageConstants {

  /**
   * The single LocationTemplateKeyStateVector
   */
  private static LocationTemplateKeyStateVector theirInstance = null;

  /**
   * The constructor is <code>private</code> to enforce <b>Singleton</b>
   * behavior
   */
  private LocationTemplateKeyStateVector() {
    super();
  }

  /**
   * Return the LocationTemplateKeyStateVector <b>Singleton</b>
   * @return The LocationTemplateKeyStateVector <b>Singleton</b>
   */
  public static LocationTemplateKeyStateVector Instance() {
    if( theirInstance == null ) {
      theirInstance = new LocationTemplateKeyStateVector();
    }
    return theirInstance;
  }

  /**
   * This state is called when a <b>&lt;LocationTemplateKeyStateVector&gt;</b> element is parsed.
