...
/**
 * Class for handling XML RoleUse tags.  This class is a <b>Singleton</b>
 ...
 */
public class RoleUse extends DocumentParseState {

  /**
   * The single RoleUse
   */
  private static RoleUse theirInstance = null;
  ...
  /**
   * Return the RoleUse <b>Singleton</b>
   * @return The RoleUse <b>Singleton</b>
   */
  public static RoleUse Instance() {
    if( theirInstance == null ) {
      theirInstance = new RoleUse();
    }
    return theirInstance;
  }

  /**
   * This state is called when we get the end element for state RoleUse
