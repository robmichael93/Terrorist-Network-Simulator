 ...
 */
public class RangeName extends DocumentParseState {

  /**
   * The single RangeName
   */
  private static RangeName theirInstance = null;
   ...
   * @return The RangeName <b>Singleton</b>
   */
  public static RangeName Instance() {
    if( theirInstance == null ) {
      theirInstance = new RangeName();
    }
