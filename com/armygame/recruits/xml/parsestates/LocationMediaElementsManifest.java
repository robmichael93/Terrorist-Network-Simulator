...
/**
 * Title: LocationMediaElementsManifest
...
/**
 * Class for handling XML LocationMediaElementsManifest tags.  This class is a <b>Singleton</b>
 ...
 */
public class LocationMediaElementsManifest extends DocumentParseState implements RecruitsPackageConstants {

  /**
   * The single LocationMediaElementsManifest
   */
  private static LocationMediaElementsManifest theirInstance = null;

  /**
   * The constructor is <code>private</code> to enforce <b>Singleton</b>
   * behavior
   */
  private LocationMediaElementsManifest() {
  }

  /**
   * Return the LocationMediaElementsManifest <b>Singleton</b>
   * @return The LocationMediaElementsManifest <b>Singleton</b>
   */
  public static LocationMediaElementsManifest Instance() {
    if( theirInstance == null ) {
      theirInstance = new LocationMediaElementsManifest();
    }
    return theirInstance;
  }

  /**
   * This state is called when we get the end element for state LocationMediaElementsManifest
