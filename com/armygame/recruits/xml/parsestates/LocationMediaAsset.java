...
/**
 * Class for handling XML LocationMediaAsset tags.  This class is a <b>Singleton</b>
 ...
 */
public class LocationMediaAsset extends DocumentParseState implements RecruitsPackageConstants {

  /**
   * The single LocationMediaAsset
   */
  private static LocationMediaAsset theirInstance = null;

  /**
   * The constructor is <code>private</code> to enforce <b>Singleton</b>
   * behavior
   */
  private LocationMediaAsset() {
    super();
  }

  /**
   * Return the LocationMediaAsset <b>Singleton</b>
   * @return The LocationMediaAsset <b>Singleton</b>
   */
  public static LocationMediaAsset Instance() {
    if( theirInstance == null ) {
      theirInstance = new LocationMediaAsset();
    }
  ...
  /**
   * This state is called when we get the end element for state LocationMediaAsset
  ...
  public void EndElement( ParserStateMachine context, String uri, String localName, String qName ) {
    context.AddConstructionTask( new ConstructionMethodCall( "SetRole", new Class[] { String.class } ) );
