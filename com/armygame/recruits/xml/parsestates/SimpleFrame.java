...
/**
 * Class for handling XML SimpleFrame tags.  This class is a <b>Singleton</b>
 ...
 */
public class SimpleFrame extends DocumentParseState {

  /**
   * The single SimpleFrame
   */
  private static SimpleFrame theirInstance = null;
  ...
  /**
   * Return the SimpleFrame <b>Singleton</b>
   * @return The SimpleFrame <b>Singleton</b>
   */
  public static SimpleFrame Instance() {
    if( theirInstance == null ) {
      theirInstance = new SimpleFrame();
    }
    return theirInstance;
  }

  /**
   * This state is called when a <b>&lt;SimpleFrame&gt;</b> element is parsed.
  ...
  public void InitializeState( ParserStateMachine context ) {
    ...
    context.AddConstructionTask( new ConstructionMethodCall( "AddSimpleFrame", new Class[] { int.class, String.class, String.class } ) );
  }

  /**
   * This state is called when we start a sub-element of state SimpleFrame
   * @param context The <code>ParserStateMachine</code> that is managing our parsing
   * @param uri
   * @param localName
   * @param qName
  ...
  /**
   * This state is called when we get the end element for state SimpleFrame
   * @param context The <code>ParserStateMachine</code> that is managing our parsing
   * @param uri
   * @param localName
   * @param qName
  ...
  /**
   * This state is called when SAX generates a <code>characters</code> event while in state SimpleFrame
   * @param context The <code>ParserStateMachine</code> that is managing our parsing
   * @param ch
   * @param start
   * @param length
