...
/**
 * Class for handling XML Branch tags.  This class is a <b>Singleton</b>
 ...
 */
public class Branch extends DocumentParseState {

  /**
   * The single Branch
   */
  private static Branch theirInstance = null;
  ...
  /**
   * Return the Branch <b>Singleton</b>
   * @return The Branch <b>Singleton</b>
   */
  public static Branch Instance() {
    if( theirInstance == null ) {
      theirInstance = new Branch();
    }
