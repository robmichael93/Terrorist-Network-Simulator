...
public class RecruitsTheme extends DefaultMetalTheme
{
    private String name = "Custom Theme";   // will be replaced
    ...
    /**
      ...
      */
    public RecruitsTheme( String resourceName )
    {
      // We will get the properties from the same jar that this file was loaded from.
      ClassLoader loader = this.getClass().getClassLoader();

      InputStream is = loader.getResourceAsStream(resourceName);//"recruitsgui.theme");
  ...
  {
   // table.put("ScrollBar.border",BorderFactory.createLineBorder(Color.red,10));
  }

  /**
      * Initialize all colors to be the same as the DefaultMetalTheme.
      */
    private void initColors() {  // use the greys, not blues...JMB
        primary1 = super.getSecondary1(); //super.getPrimary1();
        primary2 = super.getSecondary2(); //super.getPrimary2();
        primary3 = super.getSecondary3(); //super.getPrimary3();
    ...
    //protected ColorUIResource getBlack() { return new ColorUIResource(Color.black; }
    //protected ColorUIResource getWhite() { return new ColorUIResource(Color.white; }
